...
export const SYSTEM_EVENTS = [
  ...
  { name: 'audio:level',      commandable: false, detail: 'mic level crossed threshold',
    payload: '{ level }' },
  { name: 'audio:word',         commandable: false, detail: 'speech recognition registered-word trigger (final only)',
    payload: '{ word }' },
  { name: 'audio:word:interim', commandable: false, detail: 'speech recognition word as it is being spoken',
    payload: '{ word, utteranceId, wordIndex }' },
  { name: 'audio:word:final',   commandable: false, detail: 'speech recognition word from a committed utterance',
    payload: '{ word, utteranceId, wordIndex }' },

export class EditableImage {
  ...
  crop(x, y, w, h)             { this._ops.push({ type: 'crop', x, y, w, h });    this._dirty = true; return this; }
  rotate(deg)                   { this._ops.push({ type: 'rotate', deg });           this._dirty = true; return this; }
  filter(str)                   { this._ops.push({ type: 'filter', str });           this._dirty = true; return this; }
  flipH()                       { this._ops.push({ type: 'flipH' });                 this._dirty = true; return this; }
  flipV()                       { this._ops.push({ type: 'flipV' });                 this._dirty = true; return this; }
  blend(other, mode = 'screen') { this._ops.push({ type: 'blend', other, mode });   this._dirty = true; return this; }
  reset()                       { this._ops = []; this._dirty = true; return this; }
  ...
  get width()  { return this.toCanvas().width; }
  get height() { return this.toCanvas().height; }
}
